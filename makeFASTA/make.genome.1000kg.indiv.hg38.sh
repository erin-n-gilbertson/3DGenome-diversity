...
cd /dors/capra_lab/users/erin/RotationProject_Akita/data/genomes/1KG_hg38/
ml GCC
...
cut -f1-2 /gpfs51/dors2/capra_lab/data/dna/human/hg38/hg38.fasta.fai > hg38.chrom
awk '{print $1, "0", $2}' OFS='\t' hg38.chrom > hg38.chrom.bed
