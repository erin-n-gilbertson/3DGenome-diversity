...
cd $outdir
cooler cload pairix -s 2 --assembly hg38 -p $nThreads /wynton/group/capra/projects/modern_human_3Dgenome/data/genomes/hg38.chrom.bed:1000 $prefix.dedup.pairs.gz $prefix.cool
