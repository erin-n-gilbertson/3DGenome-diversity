...
# # assign variables, divergent windows
...
# outpath='/wynton/group/capra/projects/modern_human_3Dgenome/data/pairwise/divergent_windows'
...
python3 "$script" --chromosome "$chr" --window "$wndw" --outpath "$outpath" > /wynton/group/capra/projects/modern_human_3Dgenome/stdout/comps/runAkitaComps_"$SGE_TASK_ID".python.out
